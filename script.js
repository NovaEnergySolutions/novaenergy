...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        // 이메일 전송
        emailjs.sendForm('service_wy0bc3h', 'template_synj1s4', contactForm)
            .then(function(response) {
                
                const successMsg = currentLanguage === 'ko' ? '문의가 성공적으로 전송되었습니다!\n빠른 시일 내에 연락드리겠습니다.' :
                                  currentLanguage === 'en' ? 'Your inquiry has been sent successfully!\nWe will contact you soon.' :
                                  '咨询已成功发送！\n我们将尽快与您联系。';
                alert(successMsg);
