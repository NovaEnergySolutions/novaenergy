...
const productsData = {
  ...
  "novaECO-24v-230ah": {
    ...
    description: {
      ko: "NOVAECO 24V 230Ah는 트럭, 특장차, 고소작업대 및 상업용 장비 시스템에 최적화된 대용량 배터리입니다. 첨단 제조 기술과 안정적인 BMS로 안전하고 오래 사용할 수 있습니다. 그리고 NOVAENERGY만의 히팅 시스템으로 추운 겨울 극한 환경의 야외 고소작업대 환경에서도 원활한 작업을 수행할 수 있도록 제작되었습니다 (-30℃).",
      en: "The NOVAECO 24V 230Ah is a high-capacity battery optimized for trucks, specialty vehicles, aerial work platforms, and commercial equipment systems. With advanced manufacturing technology and a stable BMS, it ensures safe and long-lasting performance. Additionally, NOVAENERGY’s unique heating system enables reliable operation even in harsh winter outdoor environments for aerial work platforms (-30℃).",
      cn: "NOVAECO 24V 230Ah 是一款为卡车、特种车辆、高空作业平台及商用设备系统优化的大容量电池。采用先进制造技术和稳定的 BMS，确保安全且耐用的性能。此外，凭借 NOVAENERGY 独有的加热系统，即使在严寒的冬季户外高空作业环境中也能保持稳定运行（-30℃）。",
    },
    ...
    detailedSpecs: {
      모델명: { ko: "NOVAECO 24V 230AH (24V 시스템)", en: "NOVAECO-24V-200 (24V System)", cn: "NOVAECO-24V-200（24V系统）" },
  ...
  "novaECO-12v-100ah": {
    ...
    name: {
      ko: "NOVAECO 캠핑카·레저용 배터리 12V 100Ah",
      en: "NOVAECO Camping & Leisure Battery 12V 100Ah",
      cn: "NOVAECO 露营休闲电池 12V 100Ah",
    },
    category: {
      ko: "소형 배터리",
      en: "Compact Battery",
    ...
    description: {
      ko: "NOVAECO 12V 100Ah는 캠핑, 보트, 소형 전동 장비에 적합한 소형 배터리입니다. 경량 설계로 휴대성이 뛰어나며 안전한 BMS를 탑재했습니다.",
      en: "NOVAECO 12V 100Ah is a compact battery suitable for camping, boats, and small electric equipment. Lightweight design with excellent portability and safe BMS.",
      cn: "NOVAECO 12V 100Ah是适合露营、船只和小型电动设备的紧凑型电池。轻量化设计，便携性强，配备安全BMS。",
    },
    specs: {
      "12.8V": "12.8V",
      "100Ah": "100Ah",
    ...
    detailedSpecs: {
      모델명: { ko: "NOVAECO-12V-100 (12V 시스템)", en: "NOVAECO-12V-100 (12V System)", cn: "NOVAECO-12V-100（12V系统）" },
